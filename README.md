# Fork info
This module is been forked from the following [google billing budget module](https://github.com/terraform-google-modules/terraform-google-project-factory/tree/v14.0.0/modules/budget) using "v14.0.0"

# Budget configuration for a project

This module allows the creation of a [google billing budget](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/billing_budget) tied to a specific `project_id`
...
```hcl
module "budget" {
  source          = "dapperlabs-platform/terraform-gcp-budget"
